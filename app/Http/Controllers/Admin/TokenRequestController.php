...
class TokenRequestController extends Controller
{
    ...
    public function approve(Request $request, TokenRequest $tokenRequest)
    {
        ...
        $expiresAt = $request->filled('expires_at') ? \Carbon\Carbon::parse($request->expires_at) : null;
        ...
        try {
            ...
            \Illuminate\Support\Facades\Log::error('Failed to send token email: ' . $e->getMessage());
        }
